...
const students=["Alice: 85", "Bob: 58", "Charlie: 95", "David: 45", "Eva: 72"];
...
const passedstundents= studentsname.filter(student => student.grade > 60);
console.log(passedstundents);
